...
module.exports = function() {
    var extended = {
        ...
        template: _.template(
            ...
            '    <label for="committingTransactions">Committing Transactions</label>' +
            ...
            '    <select id="consensus" class="form-control" style="transition: none;">' +
        ...
        onData:function(status) {
            ...
            this._$('#consensusMode').val( status.config.consensusMode ? status.config.consensusMode : '' );
        },
